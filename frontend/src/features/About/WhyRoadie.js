    ...
    <div className="container whyRoadie">
      <div class="jumbotron jumbotron-fluid text-center whyRoadieJumbotron">
        <div class="row justify-content-center text-center whyRoadieHeader">
          <h1 class="display-4" id="whyRh">
            So, why <span id="WhyR">R</span>oadie?
          </h1>
        </div>
          ...
          <ul id="whyRUl">
            <div style={{ textAlign: "left" }}>
              <li>
                {" "}
                <p>
                  <span className="badge badge-success whyBadge">R</span> There
                  are too many outside parties involved in negotiating affairs.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  <span className="badge badge-success whyBadge">R</span> There
                  is no existing road map for musicians to book and plan
                  effectively.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  <span className="badge badge-success whyBadge">R</span> There
                  is no standing application to handle booking and event
                  management.
                </p>
              </li>
            </div>

...
const NavBar = () => {
    ...
    if (client === null && artist !== null) {
      return (
        <li className="nav-item active">
          <NavLink exact to={`/artist/${currentUser.id}`} className="nav-link">
            Profile
          </NavLink>
        </li>
      );
      ...
      return (
        <li className="nav-item active">
          <NavLink exact to={`/client/${currentUser.id}`} className="nav-link">
            Profile
          </NavLink>
        </li>
      );
  ...
  const displayButtons = () => {
    ...
    if (currentUser) {
      return (
        <>
          <li className="nav-item active">{routeExt()}</li>

          <button
            className="logoutBttn justify-content-end"
            id="roadieLogout"
            onClick={userLogout}
          >
            Logout
